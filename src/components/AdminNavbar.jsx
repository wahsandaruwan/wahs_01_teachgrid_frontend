    ...
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M11 4H7a2 2 0 00-2 2v12a2 2 0 002 2h6m4-16h2a2 2 0 012 2v5m-6 3h6m-6 4h6m-6-8h6"
        />
      </svg>
    )
  },
...
const AdminNavbar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 flex h-full w-72 flex-col border-r border-slate-200 bg-white px-6 py-6">
      <div className="mb-8">
      ...
      <div className="mb-8 rounded-2xl border border-slate-200 bg-slate-50 p-5 text-center">
        ...
        <span className="mt-3 inline-flex items-center rounded-full bg-slate-900 px-4 py-1 text-xs font-semibold uppercase tracking-wide text-white">
          {user.role}
        </span>
      </div>
      ...
      <button
        ...
        className="mt-6 flex items-center justify-center rounded-xl border border-red-200 px-4 py-3 text-sm font-semibold text-red-500 transition hover:bg-red-50"
      >
